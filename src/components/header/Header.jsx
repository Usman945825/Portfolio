...
import logo from "../../Images/qirabLogo.PNG";
const Header = () => {
        ...
        <header>
          <nav className="bg-black dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
              <img src={logo} className="h-8" alt="Qirab Logo" />
                ...
                <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                  <li>
                    <button
                      ...
                      className="block py-2 px-3 text-white  md:hover:text-blue-700 md:bg-transparent  md:p-0 md:dark:hover:text-blue-700"
                    >
                      Home
                    </button>
                  </li>
                  <li>
                    <button
                      ...
                      className="block py-2 px-3 text-white   md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                    >
                      About
                    </button>
                  </li>
